        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="公司名称:">
              <el-input v-model="form.companyName" class="w200"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        companyListPage(params).then(res => {
          this.pagedata = res;
      ...
      startUsing() {
        ...
        for (let i = 0; i < this.selectData.length; i++) {
          if (JSON.parse(this.selectData[i].accountStatus).name != 'DISABLE') {
            ...
            tempArr.push(this.selectData[i].companyId)
          }
        }
        ...
        this.$confirm('您确定要停用吗？', {
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              companyDisable(params).then(res => {
                this.$message({
                  type: 'success',
                  message: '停用成功!'
                });
