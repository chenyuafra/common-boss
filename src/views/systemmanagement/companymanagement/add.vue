    ...
    <div class="p20 bgfff" style="margin-top: 20px;">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px">
        <el-form-item label="公司名称:" prop="companyName">
          <el-input v-model="form.companyName" maxlength="20" class="w350"></el-input>
        </el-form-item>
        ...
        <el-form-item label="登录名:" prop="username">
          <el-input v-model="form.username" maxlength="20" class="w350"></el-input>
        </el-form-item>
...
<script>
  import { companyAdd } from '@/api/request.js';
  export default {
    name: '',
    data() {
      return {
